...
[ "$REGENERATE_SSL_CERT" = true ] && LFS_CERT=/root/ssl/server.crt; LFS_KEY=/root/ssl/server.key; bash /root/genSSLKey.sh

export LFS_LISTEN LFS_HOST LFS_METADB LFS_CONTENTPATH LFS_ADMINUSER LFS_ADMINPASS LFS_CERT LFS_KEY LFS_SCHEME
